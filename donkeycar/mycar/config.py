...
BEHAVIOR_LIST = ['frontCar', "followCar"]
BEHAVIOR_LED_COLORS =[ (0, 0,100), (100, 0, 0) ] #RGB tuples 0-100 per chanel
...
RANGE_GPIOS = [RANGE_TRIG_GPIO,RANGE_ECHO_GPIO]
...
SIGN_RIGHT_GPIO = 27
SIGN_STOP_GPIO = 22
SIGN_GPIOS=[SIGN_LEFT_GPIO,SIGN_RIGHT_GPIO,SIGN_STOP_GPIO]

#localSignDetector
LOCAL_SIGN_DETECTOR=True